...
class PokemonEncounters
  ...
  def isRedFlower?
    return false if @density==nil
    return @enctypes[EncounterTypes::RedFlower] ? true : false
  end
  
  def isWhiteFlower?
    return false if @density==nil
    return @enctypes[EncounterTypes::WhiteFlower] ? true : false
  end
  
    def isOWSpawn?
    return false if @density==nil
    return @enctypes[EncounterTypes::Land] ? true : false
  end
  ...
  def pbEncounterType
    ...
    elsif PBTerrain.isOWSpawn?(pbGetTerrainTag($game_player))
      return EncounterTypes::Land
    elsif PBTerrain.isRedFlower?(pbGetTerrainTag($game_player))
      return EncounterTypes::RedFlower
    elsif PBTerrain.isWhiteFlower?(pbGetTerrainTag($game_player))
      return EncounterTypes::WhiteFlower
    elsif self.isGrass?
      time = pbGetTimeNow
