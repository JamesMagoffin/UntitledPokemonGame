...
=end
  ...
  def pbRefresh
    ...
    $DiscordRPC.state = (_INTL("{1}/{2} Caught",$Trainer.pokedexOwned(pbGetPokedexRegion),pbGetRegionalDexLength(pbGetPokedexRegion)))
    $DiscordRPC.details = "Viewing Pokédex"
    $DiscordRPC.large_image = "pokedex"
    $DiscordRPC.update
    # Draw all text
