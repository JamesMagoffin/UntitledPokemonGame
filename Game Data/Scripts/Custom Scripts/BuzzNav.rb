...
class PokeBattle_Trainer
  ...
  def buzz
    if !@BUZZ
      @BUZZ = [
         Buzz.new(1,"Welcome to Week 1 of PokeNV!","iconchatter","ann1",true),
         Buzz.new(2,"This week is focussed on Starter Pokemon!","iconcatch","ann2",true),
         Buzz.new(3,"I found a Pokémon.","iconexplore","ann3",true),
         Buzz.new(4,"I'm a shopaholic.","iconmart","ann4",true),
         Buzz.new(5,"I like to battle.","icontrainer","ann5",false),
         Buzz.new(6,"Our region is great.","iconregion","ann1",false),
         Buzz.new(7,"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","icontrainer","ann2",false)
      ]
    end
    return @BUZZ
  end
