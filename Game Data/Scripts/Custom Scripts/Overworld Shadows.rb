...
class Sprite_Character
  ...
  def update
    ...
    if @shadow
      ...
      @shadow.visible = false if (@is_follower) && ($PokemonGlobal.surfing || $PokemonGlobal.diving || $PokemonGlobal.bicycle) #edit here!!!
    end
  end
end

UPDATED_FOR_STAIR_SCRIPT = true